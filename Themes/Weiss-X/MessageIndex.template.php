		...
		foreach ($context['boards'] as $board)
		{
			...
			// Show some basic information about the number of posts, etc.
					...
					<td class="windowbg stats">
						<strong>', $board['posts'], '</strong><br />', $txt['posts'], '
					</td>
					<td class="windowbg stats">
						<strong>', $board['topics'], '</strong><br />', $txt['topics'], '
					</td>';
...
{
echo'<tr class="titlebg" height="20"><td colspan="', empty($options['display_quick_mod']) ? '7' : '8', '">Va&#382;ne teme i obavje&#353;tenja</td></tr>';
$stickybar = true;
}
else if(!$topic['is_sticky'] && $stickybar && !$normalbar)
{
echo'<tr class="titlebg" height="20"><td colspan="', empty($options['display_quick_mod']) ? '7' : '8', '">Teme</td></tr>';
$normalbar = true;
}
			...
			echo '
					...
					<td class="lastpost ', $alternate_class, '">
						...
						<span class="smalltext">', $topic['last_post']['time'], '</span>
					</td>';

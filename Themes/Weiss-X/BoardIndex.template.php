			...
			foreach ($category['boards'] as $board)
			{
				...
				// Show some basic information about the number of posts, etc.
					...
					<td class="stats windowbg">
						<p class="largertext">', comma_format($board['posts']), ' ', $board['is_redirect'] ? $txt['redirects'] : $txt['posts'], '<br />
						<span class="fadetext">', $board['is_redirect'] ? '' : comma_format($board['topics']) . ' ' . $txt['board_topics'], '</span>
						</p>
					</td>
					<td class="lastpost">';
				...
				if (!empty($board['last_post']['id']))
					echo '
						<p><strong>', $board['last_post']['member']['link'], '</strong>  ', $txt['in'], ' ', $board['last_post']['link'], '<br />
						<span class="fadetext">', $board['last_post']['time'],'</span>
						</p>';
				echo '
					</td>
				</tr>';
			...
			<div class="title_barIC">
				<h4 class="titlebg">
					<span class="ie6_header floatleft">
						<a href="', $scripturl, '?action=recent"><img class="icon" src="', $settings['images_url'], '/icons/novo.png" alt="', $txt['recent_posts'], '" /></a>
						', $txt['recent_posts'], '
					</span>
				</h4>
			</div>
	...
	if ($settings['show_stats_index'])
	{
		echo '
			<div class="title_barIC">
				<h4 class="titlebg">
					<span class="ie6_header floatleft">
						<a href="', $scripturl, '?action=stats"><img class="icon" src="', $settings['images_url'], '/icons/stats.png" alt="', $txt['forum_stats'], '" /></a>
						', $txt['forum_stats'], '
					</span>
				</h4>
			</div>

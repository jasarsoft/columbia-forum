...
function template_main()
{
			...
			<div id="forumposts">
				<div class="cat_bar">
					<h3 class="catbg">
						...
						<span id="author"><font size="2">', $txt['author'], '</font></span>
						<font size="2">', $txt['topic'], ': ', $context['subject'], ' &nbsp;(', $txt['read'], ' ', $context['num_views'], ' ', $txt['times'], ')</font>
					</h3>
				</div>';
	...
	{
		echo '
				<p style="background:#fffffd; margin-bottom:4px; margin-top:4px; border-bottom:1px solid #e3e3e3;" id="whoisviewing" class="smalltext">';
	...
	while ($message = $context['get_message']())
	{
		...
		// Show avatars, images, etc.?
			if (!empty($settings['show_user_images']) && empty($options['show_no_avatars']) && !empty($message['member']['avatar']['image']))
				echo '
								<div class="utemi"><img src="', $message['member']['online']['image_href'], '" alt="', $message['member']['online']['text'], '" /></div><div class="avatar">
									<a href="', $scripturl, '?action=pm;sa=send;u=', $message['member']['id'], '" title="Slanje privatne poruke korisniku">
		...
		if (!empty($message['member']['group']))
			...
			if (!isset($context['disabled_fields']['posts']))
				echo '
								<div class="postcount">Postova: ', $message['member']['posts'], '</div>';
		...
		echo '
								...
								<div class="keyinfo3">
									...
									<h5 style="margin-top:5px;width:430px;white-space: nowrap; overflow: hidden; text-overflow: ellipsis;     -o-text-overflow: ellipsis; -ms-text-overflow: ellipsis;" id="subject_', $message['id'], '">
		...
		if ($settings['show_modify'] && !empty($message['modified']['name']))
			echo '
								<div class="smalltext modified">&#171; <em>', $txt['last_edit'], ': ', $message['modified']['time'], ' ', $txt['by'], ' ', $message['modified']['name'], '</em> &#187;</div>';
